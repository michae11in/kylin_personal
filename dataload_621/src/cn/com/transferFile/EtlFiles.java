...
public class EtlFiles {
		private PubAPIs pubAPIs = new PubAPIs("transferFiles");
		...
		public EtlFiles(String classname) {
		...
		public int transferCatalog(String l_loginT, String lconf_defT, String lfilePathT, String r_loginT,
				String rconf_defT, String rfilePathT) {
		...
		public int transferCatalogToTDH(String r_loginT, String rconf_defT, String lfilePathT, String rfilePathT) {
		...
		public static void main(String[] args) {
			...
			if (args.length == 3) {
				...
				l_loginT = "transferFiles_login_kerberos";
				lconf_defT = "transferFiles_conf_tdh";
				lfilePathT = "/tmp/datafile_hist/20190901/crm/001_t_crm_ods_a_d_cd_exceed_ft3_ext_c_20190901/data/";
			}
			try {
				TransferFiles transferFiles = new TransferFiles("transferFiles");
				transferFiles.transferCatalog(l_loginT, lconf_defT, lfilePathT, r_loginT, rconf_defT, rfilePathT);
			} catch (Exception e) {
				e.printStackTrace();
			}
