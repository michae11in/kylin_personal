...
//
//		public MetadataTDHBean analysTdhMetadataFromDB(TranfersDataBean tranfersDataBean)
//				throws Exception {
...
//			PubAPIs.setLogsPath(log_file_dir + "DBADataExp" + PubAPIs.getDirSign());
//			PubAPIs.setErrorLogsPath(log_file_dir + "DBADataExpError" + PubAPIs.getDirSign());
//			this.pubAPIs.setClassName(tab_full_name);
//			pubAPIs.writerLog("Run analysDBAMetadataFromTDH:" + tab_full_name);
//			try {
...
//					System.out.println("show create table sql :"+resultSql);
//				}
//				rs.close();
//				stmt.close();
//				conn_tdh.close();
...
//				System.out.println("resultSqls:"+resultSqls);
