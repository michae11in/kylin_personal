...
public class PubSMS {
	...
	public byte[] key = { 0x01, 0x23, 0x45, 0x67, (byte) 0x89, (byte) 0xab, (byte) 0xcd, (byte) 0xef, (byte) 0xfe,
	...
	public byte[] encodeSMS4(String plaintext, byte[] key) {
	 ...
	 * @return
	 */
	public byte[] decodeSMS4(byte[] ciphertext, byte[] key) {
	...
	private String decodeSMS4toString(byte[] ciphertext, byte[] key) {
		byte[] plaintext = new byte[ciphertext.length];
